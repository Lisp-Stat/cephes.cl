...
double EULER  =  0.577215664901532860606512090082402431; /* Euler's constant */

#if 0 /* we have these in C99 via math.h */
#ifdef INFINITIES
...
//extern int isnan( double x );	/* From C99, but we can't include math.h */
#else
double NAN = 0.0;
#endif
#endif
