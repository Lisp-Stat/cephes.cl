...
static double owensT2(double h, double a, double ah, double m) {
    ...
    double y = 1.0 / hs;
    double val = 0.0;
    double vi = a*exp(-0.5 * ah * ah) / sqrt(2 * PI);
